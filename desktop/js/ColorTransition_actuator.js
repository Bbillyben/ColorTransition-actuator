...
function addCmdToTable(_cmd) {
  if (!isset(_cmd)) {
   ...
   if(_cmd.logicalId =='infinite_loop' ||_cmd.logicalId =='loop' || _cmd.logicalId =='status' || _cmd.logicalId =='stop' || _cmd.logicalId =='currentColor' || _cmd.logicalId =='setCurseurTarget' || _cmd.logicalId =='curseurTarget' || _cmd.logicalId == 'move_in' || _cmd.logicalId == 'move_out' ||_cmd.logicalId == 'curseurIndex' || _cmd.logicalId == 'setCurseurIndex'  ){
